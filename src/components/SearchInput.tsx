		...
		>
			...
			>
				...
				<path
					...
					fill="#2f2e41"
				/>
				<circle cx="559" cy="744.5" r="43" fill="#777777" />
				<circle cx="54" cy="729.5" r="43" fill="#777777" />
				<circle cx="54" cy="672.5" r="31" fill="#777777" />
				<circle cx="54" cy="624.5" r="22" fill="#777777" />
			</svg>
			{showSuggestions && (
				<ul
					id="suggestions-list"
